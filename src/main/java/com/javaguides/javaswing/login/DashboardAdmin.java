...
public class DashboardAdmin extends JFrame {
	...
	public DashboardAdmin() {
		...
		panelParkingManagement = new ParkingManagement();
		panelParkingManagement.setBounds(0, 0, 732, 520);
		...
		paneDepartments.addMouseListener(new PanelButtonMouseAdapter(paneDepartments) {
			@Override
			public void mouseClicked(MouseEvent e) {
				menuClicked(panelParkingManagement);
			}
		});
		paneDepartments.setBackground(Color.LIGHT_GRAY);
		...
		paneMainContent.add(panelParkingManagement);
	...
	public void menuClicked(JPanel panel) {
		...
		panelParkingManagement.setVisible(false);
